...
@section('content')
    ...
    <p>
        ...
        We have received your company registration request, and our team is currently reviewing the provided information. We appreciate your interest in partnering with  .
    </p>
    <p>
    ...
    <p>
        If you have any urgent inquiries or additional details to share, please feel free to reply to this email or contact our dedicated support team at  .
        <br/>
