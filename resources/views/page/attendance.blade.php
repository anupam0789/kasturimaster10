...
@section('content')
    ...
    <section class="service-details">
        <h2>Do you find the Attendance Management exhausting?</h2>
        <div class="service-screen">
            <img src="{{ asset('assets/images/ss-attendance.jpg') }}" alt="attendance">
        </div>
        <div class="service-note">
            <h3>Look no further!</h3>
            <p>Our Attendance Management software, equipped with a user-friendly interface and advanced features, empowers you to easily manage Attendance for your Employees.</p>
        </div>
